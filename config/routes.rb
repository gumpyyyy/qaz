...
Lygneo::Application.routes.draw do
  ...
  get "/atom.xml" => redirect('http://blog.lygneofoundation.org/feed/atom') #too many stupid redirects :()
  ...
  get "groups" => "streams#groups", :as => "groups_stream"

  resources :groups do
    put :toggle_follower_visibility
  end
  ...
  resources :followers,           :except => [:update, :create] do
    get :sharing, :on => :collection
  end
  resources :group_pledges, :only  => [:destroy, :create]
  ...
  resources :people, :except => [:edit, :update] do
    ...
    resources :photos
    get :followers
    get "group_pledge_button" => :group_pledge_dropdown, :as => "group_pledge_button"
    get :hovercard
  ...
  get 'popular' => "followers#spotlight", :as => 'popular'
  # Mobile site

  get 'mobile/toggle', :to => 'home#toggle_mobile', :as => 'toggle_mobile'

  #Protocol Url
  get 'protocol' => redirect("http://wiki.lygneofoundation.org/Federation_Protocol_Overview")
