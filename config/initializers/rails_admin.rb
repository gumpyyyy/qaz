...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Lygneo', 'Admin']
  ...
  config.excluded_models = [ActivityStreams::Photo, GroupPledge, GroupVisibility, ShareVisibility, ConversationVisibility,  NotificationActor, Notifications::AlsoCommented, Notifications::CommentOnPost, Notifications::Liked, Notifications::Mentioned, Notifications::PrivateMessage, Notifications::RequestAccepted, Notifications::Reshared, Notifications::StartedSharing, Reshare, Services::Facebook, Services::Tumblr, Services::Twitter,  UserPreference]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [AccountDeletion, ActivityStreams::Photo, ActsAsTaggableOn::Tag, Group, GroupPledge, GroupVisibility, Block, Comment, Follower, Conversation, ConversationVisibility, Invitation, InvitationCode, Like, Mention, Message, Notification, NotificationActor, Notifications::AlsoCommented, Notifications::CommentOnPost, Notifications::Liked, Notifications::Mentioned, Notifications::PrivateMessage, Notifications::RequestAccepted, Notifications::Reshared, Notifications::StartedSharing, OEmbedCache, Participation, Person, Photo, Pod, Post, Profile, Reshare, Service, ServiceUser, Services::Facebook, Services::Tumblr, Services::Twitter, ShareVisibility, StatusMessage, TagFollowing, User, UserPreference]
  ...
  #     configure :lygneo_handle, :string 
  ...
  #     configure :group_visibilities, :has_many_association 
  ...
  #     configure :group_pledges, :has_many_association 
  #     configure :followers, :has_many_association 
  #     configure :group_visibilities, :has_many_association 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :followers_visible, :boolean 
  ...
  #   update do; end
  # end
  # config.model GroupVisibility do
  #   # Found associations:
  ...
  #   # Found associations:
  #     configure :shareable, :polymorphic_association 
  #     configure :follower, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :shareable_id, :integer         # Hidden 
  #     configure :shareable_type, :string         # Hidden 
  #     configure :created_at, :datetime 
  ...
  #     configure :follower_id, :integer         # Hidden   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :auto_follow_back_group, :belongs_to_association 
  ...
  #     configure :group_pledges, :has_many_association 
  #     configure :followers, :has_many_association 
  #     configure :follower_people, :has_many_association 
  ...
  #     configure :show_popular_in_stream, :boolean 
  #     configure :auto_follow_back, :boolean 
  #     configure :auto_follow_back_group_id, :integer         # Hidden 
