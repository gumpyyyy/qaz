...
module Salmon
 class Slap
    ...
    <lygneo xmlns="https://joinlygneo.com/protocol" xmlns:me="http://salmon-protocol.org/ns/magic-env">
      #{header(person)}
      #{@magic_sig.to_xml}
    </lygneo>
ENTRY
    ...
    def plaintext_header
      header =<<HEADER
    <author_id>#{@author.lygneo_handle}</author_id>
HEADER
    end
