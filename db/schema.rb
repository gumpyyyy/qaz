...
ActiveRecord::Schema.define(:version => 20130613203350) do
  ...
  create_table "group_pledges", :force => true do |t|
  ...
  add_index "group_pledges", ["group_id", "follower_id"], :name => "index_group_pledges_on_group_id_and_follower_id", :unique => true
  add_index "group_pledges", ["group_id"], :name => "index_group_pledges_on_group_id"
  add_index "group_pledges", ["follower_id"], :name => "index_group_pledges_on_follower_id"

  create_table "group_visibilities", :force => true do |t|
  ...
  add_index "group_visibilities", ["group_id"], :name => "index_group_visibilities_on_group_id"
  add_index "group_visibilities", ["shareable_id", "shareable_type", "group_id"], :name => "shareable_and_group_id"
  add_index "group_visibilities", ["shareable_id", "shareable_type"], :name => "index_group_visibilities_on_shareable_id_and_shareable_type"
  ...
  create_table "groups", :force => true do |t|
    ...
    t.datetime "created_at",                         :null => false
    t.datetime "updated_at",                         :null => false
    t.boolean  "followers_visible", :default => true, :null => false
    t.integer  "order_id"
  end

  add_index "groups", ["user_id", "followers_visible"], :name => "index_groups_on_user_id_and_followers_visible"
  ...
  add_index "followers", ["person_id"], :name => "index_followers_on_person_id"
  add_index "followers", ["user_id", "person_id"], :name => "index_followers_on_user_id_and_person_id", :unique => true
  ...
  create_table "people", :force => true do |t|
    ...
    t.string   "lygneo_handle",                          :null => false
  ...
  add_index "people", ["lygneo_handle"], :name => "index_people_on_lygneo_handle", :unique => true
  ...
  add_index "share_visibilities", ["follower_id"], :name => "index_post_visibilities_on_follower_id"
  ...
  create_table "users", :force => true do |t|
    ...
    t.boolean  "show_popular_in_stream",                :default => true,  :null => false
    t.boolean  "auto_follow_back",                                  :default => false
    t.integer  "auto_follow_back_group_id"
  ...
  add_foreign_key "group_pledges", "groups", :name => "group_pledges_group_id_fk", :dependent => :delete
  add_foreign_key "group_pledges", "followers", :name => "group_pledges_follower_id_fk", :dependent => :delete

  add_foreign_key "group_visibilities", "groups", :name => "group_visibilities_group_id_fk", :dependent => :delete
  ...
  add_foreign_key "share_visibilities", "followers", :name => "post_visibilities_follower_id_fk", :dependent => :delete
