...
SQL
  ...
  def self.up
    [['group_pledges', 'follower_id', 'followers'],
     ['group_pledges', 'group_id', 'groups'],
     ['comments', 'post_id', 'posts'],
     ['comments', 'person_id', 'people'],
     ['posts', 'person_id', 'people'],
     ['followers', 'person_id', 'people'],
    ...
    add_foreign_key(:group_pledges, :followers, :dependent => :delete)
    add_foreign_key(:group_pledges, :groups, :dependent => :restrict)
    ...
    add_foreign_key(:followers, :people, :dependent => :delete)
