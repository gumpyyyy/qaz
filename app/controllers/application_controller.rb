...
class ApplicationController < ActionController::Base
  ...
  before_filter :set_lygneo_header
  ...
  def all_followers_count
    @all_followers_count ||= current_user.followers.count
  end

  def my_followers_count
    @my_followers_count ||= current_user.followers.receiving.count
  end

  def only_sharing_count
    @only_sharing_count ||= current_user.followers.only_sharing.count
  end
  ...
  def set_lygneo_header
    headers['X-Lygneo-Version'] = AppConfig.version_string
