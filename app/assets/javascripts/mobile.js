...
function createUploader(){
   ...
   var groupIds = gon.preloads.group_ids;

   var uploader = new qq.FileUploaderBasic({
       element: document.getElementById('file-upload-publisher'),
       params: {'photo' : {'pending' : 'true', 'group_ids' : groupIds},},
       ...
       messages: {
          typeError: Lygneo.I18n.t("photo_uploader.invalid_ext"),
          sizeError: Lygneo.I18n.t("photo_uploader.new_photo.size_error"),
          emptyError: Lygneo.I18n.t("photo_uploader.new_photo.empty")
       },
       ...
       onComplete: function(id, fileName, responseJSON) {
        $('#fileInfo-publisher').text(Lygneo.I18n.t("photo_uploader.completed", {'file': fileName}));
