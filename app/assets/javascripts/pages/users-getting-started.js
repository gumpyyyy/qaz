Lygneo.Pages.UsersGettingStarted = function() {
  var self = this;
  ...
  this.subscribe("page/ready", function(evt, body) {
    ...
    $('#edit_profile').bind('ajax:complete', function(evt, xhr, status){
      ...
      var message = Lygneo.I18n.t("getting_started.hey", {'name': $("#profile_first_name").val()});
    ...
    $("#awesome_button").bind("click", function(evt){
      var confirmMessage = Lygneo.I18n.t("getting_started.no_tags");
      var message = Lygneo.I18n.t("getting_started.preparing_your_stream");
      var confirmation = true;

      if ($("#as-selections-tags").find(".as-selection-item").length <= 0) {
        message = Lygneo.I18n.t("getting_started.alright_ill_wait");
