#   Copyright (c) 2009, Lygneo Inc.  This file is
#   licensed under the Affero General Public License version 3 or later.  See
#   the COPYRIGHT file.

class Photo < ActiveRecord::Base
  include Lygneo::Federated::Shareable
  include Lygneo::Commentable
  include Lygneo::Shareable
  ...
  def ownership_of_status_message
    ...
    if self.status_message_guid && message
      self.lygneo_handle == message.lygneo_handle
    else
      true
    end
  end

  def self.lygneo_initialize(params = {})
    ...
    photo.lygneo_handle = photo.author.lygneo_handle
