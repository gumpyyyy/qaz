...
D_REMOTE_BASE_URL="https://raw.github.com/lygneo/lygneo/develop/"
...
to get a DEVELOPMENT setup of Lygneo* up and running

For a PRODUCTION installation, please do *not* use this script!
Follow the guide in our wiki, instead:
-- http://wiki.lygneofoundation.org/Installation_guides
...
start Lygneo* in development mode with:
