 ...
 *   the COPYRIGHT file.
 */
describe("Lygneo.Widgets.Notifications", function() {
  ...
  beforeEach(function() {
    ...
    notifications = Lygneo.BaseWidget.instantiate("Notifications", this.view.$("#notification_badge .badge_count"), this.view.$(".notifications"));
