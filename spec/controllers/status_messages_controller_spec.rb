...
describe StatusMessagesController do
  ...
  describe '#new' do
    ...
    it 'generates a jasmine fixture', :fixture => true do
      ...
      group = alice.groups.create(:name => 'people')
  ...
  describe '#create' do
    ...
    it 'takes public in group ids' do
      post :create, status_message_hash.merge(:group_ids => ['public'])
      response.status.should == 302
    end

    it 'takes all_groups in group ids' do
      post :create, status_message_hash.merge(:group_ids => ['all_groups'])
      response.status.should == 302
    end
    ...
    it "doesn't overwrite id" do
      old_status_message = alice.post(:status_message, :text => "hello", :to => @group1.id)
    ...
    it 'respsects provider_display_name' do
      status_message_hash.merge!(:group_ids => ['public'])
...
#    end
    ...
    context 'with photos' do
      before do
        @photo1 = alice.build_post(:photo, :pending => true, :user_file=> File.open(photo_fixture_name), :to => @group1.id)
        @photo2 = alice.build_post(:photo, :pending => true, :user_file=> File.open(photo_fixture_name), :to => @group1.id)
