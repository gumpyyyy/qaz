    ...
    it 'generates the stream_json fixture', :fixture => true do
      ...
      10.times do |i|
        Timecop.travel time += 1.day do
          ...
          posts << alice.post(:status_message, :text => "hella infos yo!", :to => alice.groups.first.id)
          Timecop.travel time += 1.minute
...
TXT
            ...
            posts << alice.post(:status_message, :text => "you're gonna love this.", :to => alice.groups.first.id)
          end
          Timecop.travel time += 1.minute
