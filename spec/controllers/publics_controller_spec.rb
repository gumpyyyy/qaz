...
describe PublicsController do
  ...
  describe '#receive' do
    ...
    it 'unescapes the xml before sending it to receive_salmon' do
      ...
      post1 = @user.post(:status_message, :text => 'moms', :to => [group.id])
      xml2 = post1.to_lygneo_xml
