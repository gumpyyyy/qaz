...
describe ProfilesController do
  ...
  describe '#edit' do 
    ...
    it 'sets the group to "person_edit" ' do
      get :edit
      assigns[:group].should == :person_edit
    end
  ...
  describe '#update' do
    ...
    context 'with a profile photo set' do
      before do
        ...
        eve.person.profile.image_url = "http://tom.joinlygneo.com/images/user/tom.jpg"
        eve.person.profile.save
      end
    ...
    context 'mass assignment' do
      ...
      it 'lygneo handle' do
        put :update, @profile_params
        Person.find(eve.person.id).profile[:lygneo_handle].should_not == 'abc@a.com'
      end
    end
  end
end
