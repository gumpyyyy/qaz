...
describe PhotosController do
  before do
    @alices_photo = alice.post(:photo, :user_file => uploaded_photo, :to => alice.groups.first.id)
    @bobs_photo = bob.post(:photo, :user_file => uploaded_photo, :to => bob.groups.first.id, :public => true)
  ...
  describe '#create' do
    before do
      ...
      @params = {:photo => {:user_file => uploaded_photo, :group_ids => "all"} }
    end
  ...
  describe '#destroy' do
    ...
    it 'will not let you destroy posts you do not own' do
      eves_photo = eve.post(:photo, :user_file => uploaded_photo, :to => eve.groups.first.id, :public => true)
