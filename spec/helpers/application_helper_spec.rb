...
describe ApplicationHelper do
  ...
  describe "#followers_link" do
    ...
    it 'links to community spotlight' do
      ...
      followers_link.should == popular_path
    end

    it 'links to followers#index' do
      @current_user = alice
      followers_link.should == followers_path
    end
  end
  ...
  describe '#changelog_url' do
    it 'defaults to master branch changleog' do
      ...
      changelog_url.should == 'https://github.com/lygneo/lygneo/blob/master/Changelog.md'
    ...
    it 'displays the changelog for the current git revision if set' do
      ...
      changelog_url.should == 'https://github.com/lygneo/lygneo/blob/123/Changelog.md'
      AppConfig.git_revision = old_revision
    end
