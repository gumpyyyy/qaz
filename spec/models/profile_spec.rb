...
describe Profile do
  describe 'validation' do
    ...
    describe 'from_omniauth_hash' do
      ...
      it 'outputs a hash that can update a lygneo profile' do
        profile = Profile.new
  ...
  describe '#image_url=' do
    before do
      ...
      @profile.image_url = "http://tom.joinlygneo.com/images/user/tom.jpg"
  ...
  describe 'serialization' do
    let(:person) {FactoryGirl.build(:person,:lygneo_handle => "foobar" )}

    it 'should include persons lygneo handle' do
      xml = person.profile.to_lygneo_xml
  ...
  describe '#subscribers' do
    it 'returns all non-pending followers for a user' do
